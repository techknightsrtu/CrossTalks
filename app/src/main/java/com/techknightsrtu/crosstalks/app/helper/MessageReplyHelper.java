...
public class MessageReplyHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public MessageReplyHelper(@NotNull Context context, @NotNull SwipeControllerActions swipeControllerActions) {
        super(0 , 0);
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        imageDrawable = context.getDrawable(R.drawable.ic_baseline_reply_24);
        shareRound = context.getDrawable(R.drawable.dark_circle_filled);
